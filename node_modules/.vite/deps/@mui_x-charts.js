...
import "./chunk-MUIZJIJF.js";
import "./chunk-X5JBBFKI.js";
import "./chunk-MI47HT2V.js";
import {
  warnOnce
} from "./chunk-V3E4QYHT.js";
import "./chunk-AJ6ORQHQ.js";
import "./chunk-O3PBEX5U.js";
import "./chunk-CU2C6TJJ.js";
import {
  useThemeProps
...
import "./chunk-MSJ43RUZ.js";
import "./chunk-CQN6XNLO.js";
import "./chunk-NFSKYJTT.js";
import "./chunk-LIP4WUSV.js";
import "./chunk-YUYF4PQM.js";
import "./chunk-OTX4XB7W.js";
import {
  useForkRef
} from "./chunk-NKQ3OCRA.js";
import "./chunk-GBSUBWCO.js";
import "./chunk-RQBLONSJ.js";
import "./chunk-RMLAEP2J.js";
import {
  useTheme
...
// node_modules/@mui/x-charts/esm/ScatterChart/useScatterChartProps.js
var _excluded3 = ["xAxis", "yAxis", "zAxis", "series", "axisHighlight", "voronoiMaxRadius", "disableVoronoi", "hideLegend", "width", "height", "margin", "colors", "sx", "grid", "onItemClick", "children", "slots", "slotProps", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var useScatterChartProps = (props) => {
  ...
  const seriesWithDefault = React9.useMemo(() => series.map((s) => _extends({
    type: "scatter"
  }, s)), [series]);
...
var ScatterChart = React10.forwardRef(function ScatterChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime7.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime7.jsx)(Toolbar3, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime7.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime7.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        ...
        }), (0, import_jsx_runtime7.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime7.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), children]
      })), !props.loading && (0, import_jsx_runtime7.jsx)(Tooltip, _extends({
        trigger: "item"
...
true ? ScatterChart.propTypes = {
   ...
   */
  voronoiMaxRadius: import_prop_types7.default.number,
  /**
...
var GaugeContext = React11.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React11.useContext(GaugeContext);
}
...
var GaugeContainer = React12.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
...
var Gauge = React16.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className,
...
var _excluded8 = ["apiRef", "series", "radar", "width", "height", "margin", "colors", "sx", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "hideLegend", "divisions", "shape", "stripeColor", "highlight", "showToolbar", "onAxisClick", "onAreaClick", "onMarkClick"];
...
function RadarGrid(props) {
  ...
  return shape === "sharp" ? (0, import_jsx_runtime18.jsxs)(React21.Fragment, {
  ...
  }) : (0, import_jsx_runtime18.jsxs)(React21.Fragment, {
...
var _excluded9 = ["series", "children", "width", "height", "colors", "skipAnimation", "margin", "radar", "highlight", "plugins"];
...
function RadarDataProvider(props) {
  ...
  const rotationAxes = React22.useMemo(() => [{
  ...
  const radiusAxis = React22.useMemo(() => radar.metrics.map((m) => {
    const {
      name,
      min = 0,
      max = radar.max
  ...
  const defaultizedSeries = React22.useMemo(() => series.map((s) => _extends({
    type: "radar",
  ...
  const defaultizedMargin = React22.useMemo(() => defaultizeMargin(margin, DEFAULT_RADAR_MARGIN), [margin]);
...
function useRadarRotationIndex() {
  ...
  const rotationIndexGetter = React23.useCallback(function rotationIndexGetter2(event) {
...
var _excluded10 = ["seriesId", "onItemClick"];
...
var RadarChart = React29.forwardRef(function RadarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiRadarChart"
  });
  ...
  return (0, import_jsx_runtime25.jsx)(RadarDataProvider, _extends({}, radarDataProviderProps, {
    children: (0, import_jsx_runtime25.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime25.jsx)(Toolbar3, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime25.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime25.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        ref,
        children: [(0, import_jsx_runtime25.jsx)(RadarGrid, _extends({}, radarGrid)), (0, import_jsx_runtime25.jsx)(RadarMetricLabels, {}), (0, import_jsx_runtime25.jsx)(RadarSeriesArea, _extends({}, radarSeriesAreaProps)), highlight === "axis" && (0, import_jsx_runtime25.jsx)(RadarAxisHighlight, {}), (0, import_jsx_runtime25.jsx)(RadarSeriesMarks, _extends({}, radarSeriesMarksProps)), (0, import_jsx_runtime25.jsx)(ChartsOverlay, _extends({}, overlayProps)), children]
      })), !props.loading && (0, import_jsx_runtime25.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
function RadarAxis(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)("g", {
    ...
    children: [(0, import_jsx_runtime26.jsx)("path", {
      ...
      y,
      formattedValue
    }) => (0, import_jsx_runtime26.jsx)("text", _extends({
      fontSize: 12,
      fill: (theme.vars ?? theme).palette.text.primary,
      stroke: "none",
      className: classes.label
...
var ChartContainer = React31.forwardRef(function ChartContainer2(props, ref) {
  const {
    chartDataProviderProps,
    children,
    chartsSurfaceProps
  ...
  return (0, import_jsx_runtime27.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime27.jsx)(ChartsSurface, _extends({}, chartsSurfaceProps, {
      children
    }))
  }));
});
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React32.cloneElement(render, props);
  }
  return React32.createElement(defaultElement, props);
}
...
var ToolbarContext = React33.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React33.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React33.useState(null);
  const focusableItemIdRef = React33.useRef(focusableItemId);
  const [items, setItems] = React33.useState([]);
  const getSortedItems = React33.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React33.useCallback((startIndex, step, wrap = true) => {
  ...
  const registerItem = React33.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React33.useCallback((event) => {
    if (!focusableItemId) {
      return;
    }
    const sortedItems = getSortedItems();
  ...
  const onItemFocus = React33.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React33.useCallback((id) => {
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime28.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React34.useRef(disabled);
  React34.useEffect(() => {
  ...
  const previousAriaDisabled = React34.useRef(ariaDisabled);
  React34.useEffect(() => {
...
var _excluded12 = ["className", "render"];
...
var Toolbar = React35.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime29.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
true ? Toolbar.propTypes = {
   ...
   */
  render: import_prop_types20.default.oneOfType([import_prop_types20.default.element, import_prop_types20.default.func])
} : void 0;
...
var _excluded13 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded22 = ["tabIndex"];
var ToolbarButton = React36.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
